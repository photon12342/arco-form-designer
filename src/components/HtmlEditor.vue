<template>
    <div class="_fd-html-editor">
        ...
        <a-modal class="_fd-html-editor-con" :title="title || t('struct.title')" :visible="visible"
        :mask-closable="false"
        render-to-body>
            ...
            <template #footer>
                <div>
                    ...
                    <a-button type="primary" @click="onOk" size="default">{{ t('props.ok') }}</a-button>
                </div>
            </template>
        </a-modal>
    </div>
...
._fd-html-editor-con .arco-modal-body {
    padding: 0px 20px;
}
</style>
