...
._fd-tf-col ._fd-tf-con .arco-form-item {
    margin-bottom: 1px;
}
...
._fd-tf-con .arco-form-item-content {
    display: flex;
...
._fd-tf-con .arco-input-number, ._fd-tf-con .arco-select, ._fd-tf-con .arco-slider, ._fd-tf-con .arco-cascader, ._fd-tf-con .arco-date-editor {
    width: 100%;
}
