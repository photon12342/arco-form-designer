<template>
    <div class="_fc-table-form" :class="{'_fc-disabled': disabled}">
        ...
        <a-button link type="primary" class="fc-clock" v-if="!max || max > this.trs.length"
...
._fc-table-form .form-create .arco-form-item {
    margin-bottom: 1px;
}

._fc-table-form .form-create .arco-form-item.is-error {
    margin-bottom: 22px;
}

._fc-table-form .arco-form-item-label {
    display: none !important;
}

._fc-table-form .arco-form-item-content {
    display: flex;
...
._fc-table-form._fc-disabled ._fc-tf-btn .fc-icon, ._fc-table-form._fc-disabled > .arco-button {
    cursor: not-allowed;
}
...
._fc-tf-table .arco-input-number, ._fc-tf-table .arco-select, ._fc-tf-table .arco-slider, ._fc-tf-table .arco-cascader, ._fc-tf-table .arco-date-editor {
    width: 100%;
}
</style>
