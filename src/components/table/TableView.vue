                                        ...
                                        <div class="_fd-drag-btn _fd-table-view-btn">
                                            <a-dropdown trigger="click" @command="command">
                                                ...
                                                <template #content>
                                                        ...
                                                        <a-doption divided :disabled="lattice[pid][idx].right"
                                                                          :command="['mergeRight', [{pid,idx,data: lattice[pid][idx]}]]">
                                                            {{ t('tableOptions.mergeRight') }}
                                                        </a-doption>
                                                        <a-doption :disabled="lattice[pid][idx].bottom"
                                                        ...
                                                        <a-doption divided :disabled="rule.col < 2"
                                                                          :command="['rmCol', [{pid,idx,data: lattice[pid][idx]}]]">
                                                            {{ t('tableOptions.rmCol') }}
                                                        </a-doption>
                                                        <a-doption :disabled="rule.row < 2"
